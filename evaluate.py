...
parser.add_argument('--image_data_dir', type=str, default='dataset/VOCdevkit/VOC2012/images',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='dataset/VOCdevkit/VOC2012/classes',
